  ...
  <div class="container-fluid">
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
      <div class="card-header border-0 bg-white py-3">
        <h3 class="card-title fw-900 text-dark">Pending Provider Applications</h3>
      </div>
          ...
          <table id="verificationsTable" class="table table-hover align-middle mb-0">
            <thead class="bg-light">
              <tr>
                ...
                <th class="py-3 border-0 text-center">Docs Uploaded</th>
                <th class="py-3 border-0">Requested On</th>
            ...
            <tbody>
              ...
              <tr>
                <td class="px-4">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <small class="text-muted">Parent ID: #<?= $p->id ?></small>
                    </div>
                  </div>
                </td>
                <td>
                  <div class="d-flex flex-column">
                    <span><i class="fas fa-envelope text-muted mr-1"></i> <?= esc($p->email) ?></span>
                    <span>
                ...
                <td class="text-center">
                    <span class="badge badge-info px-3 py-2"><?= $p->doc_count ?> Documents</span>
                </td>
                <td>
                  <span class="text-muted"><?= date('d M Y, h:i A', strtotime($p->created_at)) ?></span>
                </td>
                <td class="px-4 text-right">
                   <a href="<?= url('admin/provider/' . $p->id) ?>" class="btn btn-sm btn-primary rounded-pill px-3">
                      <i class="fas fa-eye mr-1"></i> View & Verify
                   </a>
                </td>
              </tr>
              <?php endforeach; ?>
